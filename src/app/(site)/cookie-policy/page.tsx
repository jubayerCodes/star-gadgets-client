      ...
      <section className="py-14">
        <div className="container max-w-3xl">
          <div className="flex flex-col gap-8 text-muted-foreground text-sm leading-relaxed">
            ...
            <p>
              This Cookie Policy explains how Star Gadgets uses cookies and similar technologies when you
              visit our website. By continuing to use our site, you consent to our use of cookies as
            ...
            <div className="flex flex-col gap-3">
              ...
              <p>
                Cookies are small text files placed on your device by a website when you visit. They are
                widely used to make websites work more efficiently, to remember your preferences, and to
                provide analytical information to website owners.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-4 mt-1">
                <div className="border border-border p-4 bg-card">
                  ...
                  <p>
                    These cookies are essential for you to use the website and cannot be disabled. They
                    are used for authentication (keeping you logged in), maintaining your shopping cart,
                    and securing your session.
                  </p>
                  <p className="mt-1 text-xs text-muted-foreground">Examples: <code>accessToken</code>, <code>refreshToken</code></p>
                </div>

                <div className="border border-border p-4 bg-card">
                  <p className="font-semibold text-foreground mb-1">Functional Cookies</p>
                  <p>
                    These cookies allow us to remember choices you make (such as saved cart items and
                    wishlist) and provide enhanced features. Disabling these may affect site functionality.
                  </p>
                </div>
                ...
                <div className="border border-border p-4 bg-card">
                  ...
                  <p>
                    ...
                    our website. This helps us understand which pages are most visited and how to improve
                    the user experience. No personally identifiable information is collected.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <p>
                When you make a payment via SSLCommerz, their payment pages may set their own cookies as
                part of the secure transaction process. We do not control these cookies. Please refer to
                SSLCommerz&apos;s privacy policy for details.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <p>
                ...
                to refuse new cookies, accept or reject specific cookies, and delete all cookies. Please
                note that disabling strictly necessary cookies may prevent you from logging in or using
              ...
              <ul className="list-disc list-inside space-y-1">
                ...
                <li>
                  <a href="https://support.mozilla.org/en-US/kb/clear-cookies-and-site-data-firefox" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
                    Mozilla Firefox
                  </a>
                </li>
                <li>
