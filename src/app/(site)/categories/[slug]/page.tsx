import CategoryProductsContent from "@/features/products/components/site/category-products-content";
import { Suspense } from "react";

// Metadata is static here; for fully dynamic titles you can convert this to
...
export default async function CategoryPage({ params }: Props) {
  ...
  return (
    <Suspense fallback={<CategoryPageSkeleton />}>
      <CategoryProductsContent categorySlug={slug} />
    </Suspense>
  );
}
