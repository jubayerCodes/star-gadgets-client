import ProductsContent from "@/features/products/components/site/products-content";
import { Suspense } from "react";

export const metadata = {
  title: "All Products — Star Gadgets",
  description:
    "Browse our full catalogue of gadgets, keyboards, mice, headphones, gamepads, and tech accessories. Filter by brand, category, price and more.",
};
...
function ProductsPageSkeleton() {
  return (
    <div className="container py-8 overflow-x-hidden">
      {/* Breadcrumb stub */}
      <div className="h-4 w-40 bg-muted animate-pulse rounded mb-5" />
