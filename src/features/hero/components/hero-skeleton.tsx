...
export const HeroFixedSkeleton = () => (
  <section className="container py-4">
    <div className="flex flex-col md:grid md:grid-cols-[5fr_2fr] gap-4 animate-pulse">
      {/* Main large panel */}
      <div className="rounded-xl aspect-video bg-foreground/[0.06]" />

      {/* Right column — 2 stacked panels */}
      <div className="flex flex-col gap-4">
        <div
          className="rounded-xl aspect-video md:flex-1 md:aspect-auto bg-foreground/[0.06]"
...
export const HeroCarouselSkeleton = () => (
  <div className="w-full animate-pulse">
    <div
      className="w-full bg-foreground/[0.06]"
