...
function SubCategoryComboboxField<T extends FieldValues, TPath extends FieldPath<T>>({
  form,
  name,
  placeholder,
  required,
  ...
  const { data, fetchNextPage, hasNextPage, isFetchingNextPage } = infinityFunction(debouncedSearchValue, categoryId);
...
export default SubCategoryComboboxField;
